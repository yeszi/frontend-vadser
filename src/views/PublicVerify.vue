<template>
  <div class="verify-page">
    ...
    <router-link to="/login" class="admin-btn">
      ...
      <span class="admin-text">Admin Access</span>
    </router-link>
    ...
    <div class="main-container">
      ...
      <div class="page-header">
        <div class="header-content">
          <h1 class="main-title">
            <span class="title-text">VERIZH</span>
            <span class="title-sub">Verifikasi Ijazah Digital</span>
          </h1>
          <p class="header-description">
            Validasi keaslian dokumen akademik 
          </p>
          <div class="blockchain-badge">
            <span class="badge-icon">🔗</span>
            <span class="badge-text">Powered by Blockchain</span>
          </div>
        </div>
      </div>
      ...
      <div class="main-content">
        <!-- Upload Section -->
        <div class="upload-section" v-if="!isVerifying && !result">
          <div class="upload-card">
            ...
            <button @click="startVerification" 
                    ...
                    :disabled="!fileToCheck">
              <span class="btn-text">Mulai Verifikasi</span>
            ...
            <div class="process-card">
              ...
              <div class="hash-display" v-if="generatedHash">
                ...
                <div class="hash-value">
                  <code>{{ shortenHash(generatedHash) }}</code>
                  <button @click="copyHash(generatedHash)" class="copy-btn" title="Salin hash">
        ...
        <transition name="slide-up">
          <div v-if="result" class="result-section">
            <div :class="['result-card', result.status === 'VALID' ? 'valid' : 'invalid']">
              ...
              <div v-if="result.status === 'VALID'" class="result-content">
                <!-- Student Information -->
...
const generateLocalHash = async (file) => {
  ...
  reader.onload = (e) => {
    // Simple hash simulation (in production use crypto-js)
...
const startVerification = async () => {
  ...
  steps.forEach((step, index) => {
    setTimeout(() => {
      ...
      estimatedTime.value = Math.max(1, 4 - step)
...
const verifyIjazah = async () => {
  ...
  try {
    ...
    if (error.response && error.response.status === 404) {
      ...
      alert("Gagal terhubung ke server. Pastikan backend Flask menyala.")
    }
  } finally {
